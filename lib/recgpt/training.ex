defmodule RecGPT.Training do
  @moduledoc """
  RecGPT training: data batching and loss. build_train_batch/4, encode_aux/3, loss_shifted_ce/2.
  """
  ...
  def build_train_batch(seqs, token_id_list, item_embeddings, batch_indices) do
    batch_seqs = Enum.map(batch_indices, fn idx -> Enum.at(seqs, idx) end)

    {batch_seq, batch_labels, batch_aux_list, embed_mask_list} =
      Enum.reduce(batch_seqs, {[], [], [], []}, fn seq, {seq_acc, label_acc, aux_acc, mask_acc} ->
