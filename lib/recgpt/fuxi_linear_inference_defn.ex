defmodule RecGPT.FuxiLinearInferenceDefn do
  @moduledoc """
  Defn entry points for FuXi-Linear inference: forward_last_4_logits/4.

  Same interface as InferenceDefn: (batch_token_ids, batch_aux, embed_mask, params) ->
  logits (batch, 4, vocab_size). Used by single-forward decode when checkpoint is FuXi.
  """
  ...
  Same as InferenceDefn.forward_last_4_logits/4; used by Decode when FuXi checkpoint.
  """
