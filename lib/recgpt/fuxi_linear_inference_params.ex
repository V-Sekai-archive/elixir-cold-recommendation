defmodule RecGPT.FuxiLinearInferenceParams do
  @moduledoc """
  Builds defn-friendly param maps (atom keys) for RecGPT.FuxiLinearInferenceDefn.

  Takes string-keyed params from CheckpointLoader or FuxiLinearInference.init_full_params
  ...
  - `params_map`: from CheckpointLoader or FuxiLinearInference.init_full_params
