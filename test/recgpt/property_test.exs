...
defmodule RecGPT.PropertyTest do
  ...
  property "trie build and lookup round-trip: every item_id maps back via its token list" do
    four_tokens = StreamData.list_of(StreamData.integer(0..@vocab_max), min_length: 4, max_min_length: 4, max_length: 4)
