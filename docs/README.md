...
| 84  | [84 FuXi-Linear implementation](84_fuxi_linear_implementation_plan.md)                                | Full FuXi-Linear in Nx/Elixir; RecGPT semantic ID interface.                                   | Retention, LinearTemporalChannel, LinearPositionalChannel; init_params.                                                                |
| 85  | [85 FuXi-Linear status](85_fuxi_linear_status.md)                                                       | What is implemented vs remaining (Defn/JIT, checkpoint, training, chunk).                     | Implementation status.                                                                                                                |
...
| **Frontier models in EXLA/Elixir**                  | [83 Frontier models EXLA path](83_frontier_models_exla_elixir_path.md) — FuXi, Mamba, RWKV; defn/while path. [84](84_fuxi_linear_implementation_plan.md) implementation, [85](85_fuxi_linear_status.md) status.             |
