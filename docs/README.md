...
| 86  | [86 Training signal test dataset plan](86_training_signal_test_dataset_plan.md)                | One small dataset for validating pretrain signal (loss/Hit@k).                                | Plan; pick subset from KuaiRand/MovieLens/MerRec/Open-Ecommerce.                                                                     |
| 87  | [87 MovieLens training signal log](87_movielens_training_signal_log.md)                       | MovieLens-20M pretrain run: loss 8.87 → 0.53 in 200 iters.                                  | Log; pipeline commands.                                                                                                              |
| 88  | [88 Training domain recommendation](88_training_domain_recommendation.md)                     | Use Steam for training signal; MovieLens/others for experiments or FuXi from scratch.        | Domain match, Hit@k, pipeline.                                                                                                        |
...
| 79  | [79 Why EXLA over Torchx](79_exla_over_torchx.md)                                                   | Reasoning for using EXLA (XLA) instead of Torchx (LibTorch) for inference.                     | Backend choice; batched KV-cache; ecosystem.                                                                                          |
| 80  | [80 Prediction market trading system](80_prediction_market_trading_system.md)                         | Scout-first; train for signal; rope bridge → busy road → highway.                              | Copytrade context; survivorship.                                                                                                     |
| 81  | [81 Scout vs Gatekeeper merge feasibility](81_scout_gatekeeper_merge_feasibility.md)                  | Can we merge Scout and Gatekeeper into one model? Keep separate.                               | Scout + Gatekeeper; Tape + XMP.                                                                                                       |
| 82  | [82 Zero-shot semantic id reuse](82_zeroshot_semantic_id_reuse.md)                                    | What else can do zero-shot RecGPT; reuse fixture, trie, decode.                                | FSQ, semantic id, backend-agnostic.                                                                                                  |
| 83  | [83 Frontier models: EXLA/Elixir path](83_frontier_models_exla_elixir_path.md)                         | Path from Nx/EXLA to FuXi, Mamba, RWKV; feasibility per model.                                 | defn, while, linear attention, selective scan.                                                                                        |
| 84  | [84 FuXi-Linear implementation](84_fuxi_linear_implementation_plan.md)                                | Full FuXi-Linear in Nx/Elixir; RecGPT semantic ID interface.                                   | Retention, LinearTemporalChannel, LinearPositionalChannel; all_timestamps, chunk_size opts; init_params.                             |
| 85  | [85 FuXi-Linear status](85_fuxi_linear_status.md)                                                       | Implemented: Serve, AxonTrain, export_fuxi_ckpt, all_timestamps, chunk_size.                   | Implementation status.                                                                                                                |
...
| **Why EXLA over Torchx**                          | [79 Why EXLA over Torchx](79_exla_over_torchx.md) — Backend choice rationale.                                                                                                               |
...
| **Scout vs Gatekeeper merge?**                     | [81 Scout vs Gatekeeper merge feasibility](81_scout_gatekeeper_merge_feasibility.md) — Keep separate; different inputs, architectures.                                                      |
| **Zero-shot semantic id reuse**                    | [82 Zero-shot semantic id reuse](82_zeroshot_semantic_id_reuse.md) — Alternative recommenders reusing fixture, trie, FSQ.                                                                      |
| **Frontier models in EXLA/Elixir**                  | [83 Frontier models EXLA path](83_frontier_models_exla_elixir_path.md) — FuXi fully wired; Mamba, RWKV feasibility. [84](84_fuxi_linear_implementation_plan.md) plan, [85](85_fuxi_linear_status.md) status.             |
