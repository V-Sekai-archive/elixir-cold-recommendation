...
| 22  | [22_quality_assurance.md](features/22_quality_assurance.md)                                    | Run the QA checklist before merge or release.                                                 | Compile, format, Credo, unit tests, Dialyzer; Steam top-k; CI.                                                                        |
| 23  | [23_staff_api.md](features/23_staff_api.md)                                                     | Staff API for catalogues, sequences, fixture, pretrain.                                       | RecGPT.StaffApi behaviour; list/upsert items; sync sequences; build_fixture; pretrain; set_canonical_texts.                           |
| 24  | [24_waffle_ecto_usage.md](features/24_waffle_ecto_usage.md)                                     | Blob storage with Ecto and optional object store.                                             | waffle_ecto + Waffle: schema, cast_attachments, local/S3 config.                                                                      |
| 25  | [25_ycsb_storage_classification.md](features/25_ycsb_storage_classification.md)                   | Classify storage by YCSB workload types and throughput.                                       | YCSB A–F; database/store fit; RecGPT artifact mapping.                                                                                |
| 26  | [26_spmd_decode_flow.md](features/26_spmd_decode_flow.md)                                       | Minimize CPU–device sync in beam search; keep trie and scoring on device.                     | Trie tensors; SPMD beam search; single sync; lib/ modules (Trie, Decode, Serve).                                                      |
| 27  | [27_latency_and_performance.md](features/27_latency_and_performance.md)                              | Industry context, batched inference, KV-cache, SLO targets.                                   | P50/P99 targets; latency_flow.                                                                                                        |
| 28  | [28_quick_start.md](features/28_quick_start.md)                                                    | Getting started; run the pipeline.                                                            | Split from root README.                                                                                                               |
| 29  | [29_mix_tasks.md](features/29_mix_tasks.md)                                                         | Commands and options.                                                                         | Split from root README.                                                                                                               |
| 30  | [30_modules_overview.md](features/30_modules_overview.md)                                            | Module reference.                                                                             | Split from root README.                                                                                                               |
| 31  | [31_dependencies.md](features/31_dependencies.md)                                                   | Nx, EXLA, Bumblebee, etc.                                                                     | Split from root README.                                                                                                               |
| 32  | [32_dev_container.md](features/32_dev_container.md)                                                 | Torchx dev container setup.                                                                  | Split from root README.                                                                                                               |
| 33  | [33_tests.md](features/33_tests.md)                                                                 | Running tests.                                                                                | Split from root README.                                                                                                               |
| 34  | [34_grpc_serve.md](features/34_grpc_serve.md)                                                       | gRPC API and serve.                                                                           | Split from root README.                                                                                                               |
| 35  | [35_versioning_and_references.md](features/35_versioning_and_references.md)                          | Versioning and refs.                                                                          | Split from root README.                                                                                                               |
| 36  | [36_latency_flow.md](features/36_latency_flow.md)                                                  | E2E flow diagram, per-stage optimization.                                                     | GPU tensor graph.                                                                                                                     |
| 37  | [37_nsys_tracing.md](features/37_nsys_tracing.md)                                        | Profile with nsys and NVTX.                                                                   | nsys, NVTX.                                                                                                                           |
| 38  | [38_bulk_data_not_in_git.md](features/38_bulk_data_not_in_git.md)                                  | What bulk data exists (data/, checkpoints); gitignored; how to save/restore.                   | Inventory; back up strategy.                                                                                                         |
| 39  | [39_fuxi_linear_status.md](features/39_fuxi_linear_status.md)                                       | Implemented: Serve, AxonTrain, export_fuxi_ckpt, all_timestamps, chunk_size.                   | Implementation status.                                                                                                                |
| 40  | [40_train_test_loss_loop.md](features/40_train_test_loss_loop.md)                                | `--eval-test-every --test` for train/test loss progress; best test loss tracking.             | Generalization; early stopping.                                                                                                        |
| 41  | [41_fuxi_linear_real_timestamps.md](features/41_fuxi_linear_real_timestamps.md)                      | Pass real timestamps to FuXi-Linear; prediction-market aligned; rope bridge.                  | Converter, DB, training, Serve; leader sequence format.                                                                               |
| 42  | [42_figgie_arbitrage.md](features/42_figgie_arbitrage.md)                                  | Figgie game simulation and real-time arbitrage using RecGPT sequential modeling.               | Game mechanics; arbitrage detection; training pipeline; performance optimizations.                                                   |
...
| **Bulk data (not in git)**                         | [39 Bulk data not in git](features/39_bulk_data_not_in_git.md) — `mix recgpt.refetch`; what to back up.                                                                     |
| Understand SPMD decode (trie tensors, single sync) | [27 SPMD decode flow](features/27_spmd_decode_flow.md) — Trie.to_tensors, Decode.beam_search_top_k_spmd, Serve.recommend.                                                    |
| Quick start, pipeline, mix tasks, tests, etc.      | [29](features/29_quick_start.md)–[36](features/36_versioning_and_references.md) — Split from root README.                                                                     |
| **Latency flow, nsys, FuXi**                       | [37 Latency flow](features/37_latency_flow.md), [38 Nsight Systems](features/38_nsys_tracing.md), [89 FuXi latency log](archived/89_fuxi_latency_log.md).                    |
...
| **Phase 1 pretraining**                            | [43 Pretraining plan](features/43_pretraining_plan.md) — KuaiRand-Pure; prove signal at FuXi loss.                                                             |
| **Video-domain trajectory test (design)**         | [44 Video-domain trajectory test](features/44_video_domain_trajectory_test.md) — Next-video eval on watch trajectories; design choices.                       |
