...
The codebase does not use ETS today; this is the recommended path from “load fixture at startup” to “update catalog at runtime” (IURS-style). The unified API ([13](13_grpc_rest_api.md), [14](14_api_schemas.md)) includes **CatalogService** for live catalog updates.
