...
Document **algorithmic foundations**: FSQ and semantic tokenization, hybrid bidirectional“causal attention, and the pipeline/module mapping. Pipeline order and commands: [02_pipeline_overview.md](02_pipeline_overview.md).
