...
Gamed-ness affects *execution risk* (slippage, resolution manipulation, liquidity), not the arithmetic. Strategy: compute butterfly profit everywhere, then **size by gamed-ness**.
...
| **Triple-Lock Pass Rate** | % of trades with Organic Tape + Rule Alignment + News Signal |
